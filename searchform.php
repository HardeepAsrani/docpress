...
<form role="search" method="get" class="search-form" action="<?php echo home_url( '/' ); ?>">
    <input type="search" class="search-field" placeholder="<?php if(!empty($docpress_header_search_label)) : echo $docpress_header_search_label; endif; ?>" value="<?php echo get_search_query() ?>" name="s" title="<?php echo _x( 'Search for:', 'docpress' ) ?>" />
